		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
    		<ul class="navbar-nav mr-auto">
      			<li class="nav-item active">
        			<a class="nav-link" href="champion.php">Tous les champions<span class="sr-only">(current)</span></a>
			  	</li>
			</ul>
    		<form action="recherche.php" method="get" class="form-inline my-2 my-lg-0">
				<section class="flex_recherche">
					<article>
						...
						<input id="color_button_header" class="btn my-2 my-sm-0"  type="submit" />
					</article>
